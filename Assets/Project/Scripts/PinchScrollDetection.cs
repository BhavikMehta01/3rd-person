...
public class PinchScrollDetection : MonoBehaviour 
{
	...
	[SerializeField] int cameraFieldOfViewMin, cameraFieldOfViewMix;
	...
	private void CameraZoom(float increment) => Camera.main.fieldOfView = Mathf.Clamp(Camera.main.fieldOfView + increment, cameraFieldOfViewMin, cameraFieldOfViewMix);
}